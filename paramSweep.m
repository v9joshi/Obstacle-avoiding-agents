...
% Load the parameters
paramTable = readtable('parameters20200812.csv');
...
for setNum = 13:length(paramSet)
    ...
    for repNum = 1:numReps
        ...
        save(['Data3\',fileName,'.mat'],'agent','goalReachTime','environment','simParameters','agentParameters','obstacleParameters')    
