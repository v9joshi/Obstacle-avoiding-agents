...
function decisionInput = agentPerception3_dev(currAgent, stateList, params)
    ...
    agOr = agentOrientation(currAgent);
...
%     relativeWSLocations = waterSourceLocations - repmat(currAgentPosition, size(waterSourceLocations, 1), 1);
    ...
    relativeWSLocations =  currAgentPosition + 1000*[cos(agOr-pi/2),sin(agOr-pi/2)];
