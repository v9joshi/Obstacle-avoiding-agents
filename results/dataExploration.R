...
data <- read.csv ("data20201020/summaryData20201020.csv")
paramMetaData <- read.csv ("paramMetaData20201020.csv")
goalTimesData <- read.csv ("data20201020/goalTimesData20201020.csv")

data <- mutate (data, 
                RealSetNum = 
                  gsub("R", "", gsub("/", "", substring(FileName, 131, nchar(as.character(FileName))-8))),
                RealRepNum = 
                  gsub("p", "", gsub("e", "", substring(FileName, 136, nchar(as.character(FileName))-4))))
...
#   see most of the agest move backwards, and most succeed. 
...
#              file = paste0 ("data20200812/processedDataWorking.csv"),
